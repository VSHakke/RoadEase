...
class AssistantMethods
{
  ...
  {
    streamSubscriptionPosition!.pause();//stop live location updates
    Geofire.removeLocation(currentFirebaseUser!.uid);
  }

  static resumeLiveLocationUpdates()
  {
    streamSubscriptionPosition!.resume();//resume the  live location updates
    Geofire.setLocation(
      currentFirebaseUser!.uid,driverCurrentPosition!.latitude,driverCurrentPosition!.longitude);
  }
}